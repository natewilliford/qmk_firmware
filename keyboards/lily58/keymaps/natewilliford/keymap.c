...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,TG(_COLMAK),TG(_NUMPAD),KC_N,    KC_M, KC_COMM,  KC_DOT,  KC_SLSH, KC_RSFT,
 ...
 * |   `  |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Home |Ctrl<-|Mlt Up|Mlt Dn|  End |Ctrl->|-------.    ,-------|Ctrl<-| Left | Down |  Up  |Right |Ctrl->|
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |      | Mute | Vol+ | Vol- |Ply/Ps|      |-------|    |-------|   +  |   -  |   =  |   [  |   ]  |   \  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | PGUP | PGDN |      | /Space  /       \BackSP\  |RAISE |Enter | RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_RAISE] = LAYOUT(
  ...
  _______, KC_MUTE, KC_VOLU, KC_VOLD, KC_MPLY, _______, _______, _______, KC_PLUS, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
                             KC_PGUP, KC_PGDN, _______, _______, _______, _______, _______, _______
),
...
[_NUMPAD] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,  _______, _______,  KC_PLUS, KC_P0, KC_0, KC_PDOT, _______, _______,
                             _______, _______, _______,  _______, _______, _______,   _______, _______
),
