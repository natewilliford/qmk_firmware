...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_CAPS, KC_HOME, KC_PGUP, KC_PGDN, KC_END,  _______, LCTL(KC_LEFT), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, LCTL(KC_RGHT),
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK,  TO(_NUMPAD), TO(_NAVIGATION),  _______,
    _______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  TERM_ON, TERM_OFF, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______
),

[_NUMPAD] = LAYOUT_planck_grid(
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_PSLS, KC_P7, KC_P8,   KC_P9,   KC_PMNS, KC_BSPC,
    _______, _______, _______, KC_LPRN, KC_RPRN, _______, KC_PAST, KC_P4, KC_P5,   KC_P6,   KC_PPLS, _______,
    _______, _______, _______, _______, _______, _______, _______, KC_P1, KC_P2,   KC_P3,   KC_PEQL, _______,
    _______, _______, _______, _______, TO(0),   KC_SPC,  KC_BSPC, TO(0), KC_P0,   KC_PDOT, _______, _______
),

[_NAVIGATION] = LAYOUT_planck_grid(
    _______, _______, _______, KC_PGUP, _______, _______, _______, LCTL(KC_LEFT), KC_UP,   LCTL(KC_RGHT), _______, _______,
    _______, _______, KC_HOME, KC_PGDN, KC_END,  _______, _______, KC_LEFT,       KC_DOWN, KC_RGHT, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______,       _______, _______, _______, _______,
    _______, _______, _______, _______, TO(0),   KC_SPC,  KC_SPC,   TO(0),        _______, _______, _______, _______
)
...
bool custom_hold_ctrl_intercept(uint16_t keycode, keyrecord_t *record){
